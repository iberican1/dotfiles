...
thumblink=https://www.prayerscapes.com/Images_3/Edits/MG_sunrise_mid.jpg
...
#printf '%.0s\n' {1..3}
printf "\n"
# Removing spaces and special charachters" "printf 'Removing spaces and special charcters\n'
detox "$video"
detox "$audio"
printf "\n"
printf 'Video DL Comleted under the following path: \n'
printf "\n"
printf "$audio"
printf "\n"
printf "\n"
